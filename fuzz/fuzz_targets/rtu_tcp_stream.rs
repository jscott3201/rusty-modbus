...
use rusty_modbus_frame::rtu_tcp::{RtuOverTcpCodec, RtuOverTcpDirection, RtuOverTcpFramingPolicy};
...
fuzz_target!(|input: &[u8]| {
    ...
    for direction in [RtuOverTcpDirection::Request, RtuOverTcpDirection::Response] {
        let strict =
