...
use modbus_tcp::transport::TransportStream;
use modbus_tcp::TcpRecvStream;
use tokio::sync::watch;

use crate::error::ClientError;
use crate::transaction::TransactionManager;
use modbus_types::TransactionId;
                    ...
                    match result {
                        ...
                        Err(modbus_tcp::TransportError::Disconnected) => {
                            ...
                            txn_mgr.cancel_all(|| ClientError::Transport(
                                modbus_tcp::TransportError::Disconnected,
                            ));
                            break;
                        }
                        Err(e) => {
                            ...
                            txn_mgr.cancel_all(|| ClientError::Transport(
                                modbus_tcp::TransportError::Timeout, // generic
                            ));
                            let _ = e;
                            break;
                        }
